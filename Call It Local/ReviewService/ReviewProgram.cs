...
namespace EchoService
{
    ...
    class ReviewProgram
    {
        ...
        {
            Console.Title = "ReviewService";

            //Create a new Endpoint configuration with the name "ReviewService"
            EndpointConfiguration endpointConfiguration = new EndpointConfiguration("ReviewService");
            ...
            routing.RegisterPublisher(typeof(ReviewEvent), "Authentication");
